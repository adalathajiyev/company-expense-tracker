-- Company Expense Tracker database baseline
-- Schema only: this migration intentionally contains no production data.
...
-- -----------------------------------------------------------------------------
-- Owner funding
-- Source: supabase/owner_funding_schema.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Sales and sale payments
-- Source: supabase/sales_schema.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Worker debts and debt payments
-- Source: supabase/debts_schema.sql
-- -----------------------------------------------------------------------------
...
-- Source: supabase/salaries_schema.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Balance adjustments and cash balance view
-- Source: supabase/balance_schema.sql
-- -----------------------------------------------------------------------------
